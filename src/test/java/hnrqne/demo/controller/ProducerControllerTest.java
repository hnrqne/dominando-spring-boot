...
import hnrqne.demo.repository.ProducerData;
...
class ProducerControllerTest {
    ...
    void init(){
        ...
        var producers = new ArrayList<>(List.of(ufotable, wifStudio, studioGhibli));
    ...
    @Order(5)
    void update_UpdateProducer_WhenSucessful() throws Exception {
    ...
    @Order(7)
    void delete_RemovesProducer_WhenSucessful() throws Exception{
